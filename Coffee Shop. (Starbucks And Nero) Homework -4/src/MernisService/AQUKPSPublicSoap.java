...
public class AQUKPSPublicSoap
{
    ...
    public AQUKPSPublicSoap(){}

    public AQUKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public AQUKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        AQUExtendedSoapSerializationEnvelope envelope= new AQUExtendedSoapSerializationEnvelope(AQUExtendedSoapSerializationEnvelope.VER11);
