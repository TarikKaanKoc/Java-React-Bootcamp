...
public class AQUExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(AQUDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new AQUStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static AQUDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static AQUDateTimeConverter dateTimeConverter = new AQUStandardDateTimeConverter();

    public AQUExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public AQUExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new AQUMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=AQUHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,AQUExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=AQUHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
